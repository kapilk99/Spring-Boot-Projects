...
<%@page import="com.java.mycart.helper.Helper"%>
    ...
    <body>
        ...
        <div class="container admin">
            ...
            <div class="row mt-3">
                ...
                <!--third col-->
                <div class="col-md-4"data-toggle="tooltip" data-placement="right" title="Total numers of Products">
                ...
                <div class="col-md-12">
                    ...
                    <div onclick="window.location='view_products.jsp'"class="card"data-toggle="tooltip" data-placement="top" title="Click here to view all the products" >
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded" src="img/search.png" alt="user_icon">

                            </div> 

                            <p class="mt-2">Click here to view all the products</p>
                            <h1 class="text-uppercase text-muted">View All Products</h1>
